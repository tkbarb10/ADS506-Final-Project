...
This dataset contains 2,109 monthly observations from 1850–2025, with global temperature anomalies and uncertainties, where **Monthly_Anomaly** is the primary usable series and most multi-year anomaly fields contain NA values except at the end of their smoothing windows.
...
climate_ts |>
  autoplot(Monthly_Anomaly) +
  labs(
    title = "Annual Global Temperature Anomalies",
    x = "Year",
...
climate_ts |>
  features(Monthly_Anomaly, unitroot_ndiffs)
