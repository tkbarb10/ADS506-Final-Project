...
# External Predictor Feature Engineering Steps
...
The annual data for ch4 was cutoff from 1850.  Fill gaps can create NA rows for monthly
data in between years, then the NA's can be fill in with the most recent known observation.  
