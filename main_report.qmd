...
tslm_fc |>
  ...
  filter(.id %in% c(4, 5), .model %in% c("tslm_no_trend", "tslm_enso_smooth_lag", "tslm_nino_50_lag", "tslm_co2_nino_lag", "tslm_box_cox")) |> 
  autoplot() + 
...
arima_fit <- arima_trn |> 
  model(
    ...
    arima_lag_ten = ARIMA(actual_temp ~ co2_lag1 + PDQ(D=1)),
    arima_lag_ten_nino = ARIMA(actual_temp ~ co2_lag1 + el_nino + la_nina + PDQ(D=1)),
