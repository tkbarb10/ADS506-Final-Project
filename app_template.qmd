...
country_2024_baseline <- read_rds("country_2024_baseline_Gt.rds")
```
...
input_growth_pct <- 2.0  # User wants 1% monthly growth in emissions
...
full_data_linked <- bind_rows(modeling_data, future_scenario)
